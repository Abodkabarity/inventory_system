...
class LoadAdditionalOrderHistory extends InventoryEvent {
  final DateTime from;
  final DateTime to;

  LoadAdditionalOrderHistory({required this.from, required this.to});
...
class SendAllocationToBranches extends InventoryEvent {
  ...
  @override
  List<Object?> get props => [runDate, batchTitle, expiresAt];
}
