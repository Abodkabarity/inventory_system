                                                  ...
                                                  OrdersToolbar.actionButton(
                                                    ...
                                                    color:
                                                      ...
                                                      (!zoneReady ||
                                                        ...
                                                        final row = bloc.state.rows.firstWhere(
                                                        ...
                                                        final hasTma =
                                                        row.tmaQty != null &&
                                                        row.tmaQty.toString() != '0';
  
                                                        final edit =
                                                        bloc.state.finalEdits[item.itemCode];
                                                        ...
                                                        context: context,
                                                        state: context.read<OrdersBloc>().state,
                                                        zone: zs.zone!,
                                                        );
                                            ...
                                            child: Builder(
                                              builder: (_) {
                                                ...
                                                return OrdersTable(
                                                  ...
                                                  submitStartHour: s.submitStartHour,
